...
substring(str1,3,6) = "${fn:substring(strl,3,6) }" <br />
substringAfter(str1, str2) = "${fn:substringAfter(strl, str2) }" <br />
substringBefore(str1, str2) = "${fn:substringBefore(strl, str2) }" <br />
